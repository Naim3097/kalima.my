...
import { Card, CardHeader, DemoNote, Pill, StatCard, Table, Td, Tr } from "@/components/admin/ui";
import { COURIER_QUOTES, ORDERS, SHIPMENTS } from "@/data/demo";
import { formatRM } from "@/lib/format";

export const metadata: Metadata = {
  title: "Shipping · Admin",
  description: "EasyParcel rates, consignment booking, AWB labels and tracking.",
};

const TIMELINE: [string, string][] = [
  ["17 Jul, 08:12", "Departed sorting hub — Shah Alam"],
  ["16 Jul, 21:40", "Arrived at sorting hub — Bukit Raja"],
  ["16 Jul, 15:05", "Picked up by J&T Express"],
  ["16 Jul, 14:00", "AWB generated, customer notified via WhatsApp"],
];

/*
  Server Component. The courier quote list is a static demo mock-up (the
  first option is pre-selected in markup, nothing is wired), so no client
  boundary is needed.
*/
