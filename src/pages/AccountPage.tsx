  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <div className="bg-navy p-8 text-white">
          <div className="flex items-start justify-between">
            ...
            <img src="/brand/kalima-mark-white.png" alt="" className="h-12 w-auto opacity-80" />
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="h-1.5 w-full bg-white/15">
              <div className="h-1.5 bg-white" style={{ width: "89%" }} />
            </div>
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        {[
          ...
          <div key={b.title} className="border border-navy/10 bg-white px-5 py-4">
            ...
            <button className="mt-3 text-[12px] text-navy underline underline-offset-4 cursor-pointer">Edit</button>
          </div>
        ))}
      </section>
      ...
      <p className="mt-8 text-[12px] tracking-wide text-navy-300">
        ...
        <Link to="/affiliate" className="text-navy underline underline-offset-4">
