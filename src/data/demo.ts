...
export const INBOX_CHANNEL_META: Record<InboxChannel, { label: string; color: string }> = {
  shopee: { label: "Shopee", color: "#ee4d2d" },
  tiktok: { label: "TikTok Shop", color: "#161823" },
...
export type Conversation = {
  ...
  unread: boolean;
  linkedOrder?: string;
  messages: { from: "customer" | "kalima"; text: string; time: string }[];
};
...
export const CONVERSATIONS: Conversation[] = [
  {
    id: "c1",
    channel: "shopee",
    customer: "sitikhadijah_92",
    preview: "Hi, bila order saya akan sampai ye?",
    time: "10:51",
    unread: true,
    linkedOrder: "SPE-88121",
    messages: [
      { from: "customer", text: "Hi, bila order saya akan sampai ye?", time: "10:51" },
    ],
  },
  {
    id: "c2",
    channel: "instagram",
    customer: "@ainasofia.x",
    preview: "Is the Ruwa Kaftan restocking in size S?",
    time: "10:22",
    unread: true,
    messages: [
      { from: "customer", text: "Hi! Love the new collection 😍", time: "10:20" },
      { from: "customer", text: "Is the Ruwa Kaftan restocking in size S?", time: "10:22" },
    ],
  },
  {
    id: "c3",
    channel: "tiktok",
    customer: "hanizulaikha",
    preview: "Can I change my delivery address?",
    time: "09:47",
    unread: false,
    linkedOrder: "TTS-40917",
    messages: [
      { from: "customer", text: "Can I change my delivery address?", time: "09:40" },
      { from: "kalima", text: "Hi Hani! Sure — as long as the parcel hasn't been booked. What's the new address? 💌", time: "09:47" },
    ],
  },
  {
    id: "c4",
    ...
    preview: "Thank you! Payment done ✅",
    time: "Yesterday",
    unread: false,
    linkedOrder: "KLM-10248",
    messages: [
      { from: "kalima", text: "Hi Nurul! Your Kalima order KLM-10248 is confirmed 🤍 We'll WhatsApp you the tracking once it ships.", time: "Yesterday" },
      { from: "customer", text: "Thank you! Payment done ✅", time: "Yesterday" },
    ],
  },
];
